...
# Load models (make sure the paths to the models are correct)
try:
    POTATO_MODEL = tf.keras.models.load_model("C:/Users/Rakshana S/Downloads/Smart-Farming-main/Smart-Farming-main/models/1.h5")
    CORN_MODEL = tf.keras.models.load_model("C:/Users/Rakshana S/Downloads/Smart-Farming-main/Smart-Farming-main/models/corn.keras")
    APPLE_MODEL = tf.keras.models.load_model("C:/Users/Rakshana S/Downloads/Smart-Farming-main/Smart-Farming-main/models/apple.keras")
